...
b_1$graph + theme_thesis(15) + xlab("U937 Stimulation") + ylab("THP-1 Stimulation") + ggtitle(label="")
...
n = jointGeneOrdering(bundle=results_bundle, contrasts=c("c.THP1.pma.prime","c.THP1.vd3.prime"), n=n, metric=min)
...
plotCrossClusterGrid(a_2, yscale=NULL)

jointRegulationPlot(a_2, contrasts=list(list(contrast="c.THP1.pma.prime", stimulus="PMA"), list(contrast="c.THP1.vd3.prime", stimulus="VD3")), onlyGeneSets=T, nSets=5)$g12
...
n = jointGeneOrdering(bundle=results_bundle, contrasts=c("c.U937.pma.prime","c.U937.vd3.prime"), n=n, metric=min)
...
plotCrossClusterGrid(b_2, yscale=NULL)

jointRegulationPlot(b_2, contrasts=list(list(contrast="c.U937.pma.prime", stimulus="PMA"), list(contrast="c.U937.vd3.prime", stimulus="VD3")), onlyGeneSets=T, nSets=5)$g12
